...
#End Region
    ...
    Public Shared Function IsPrinterOnline(ByVal printerName As String) As Boolean
        ...
        Return online
    End Function
    Public Shared Sub GenerarImpCrystal5(ByRef oObjGlobal As EXO_UIAPI.EXO_UIAPI, ByVal rutaCrystal As String, ByVal sCrystal As String,
                                        ByVal sDocNum As String, ByVal sLote As String, ByVal sFileName As String, ByRef sReport As String,
        ...
        Try
            ...
            oCRReport.SetParameterValue("Articulo", sDocNum)
            oCRReport.SetParameterValue("LOTE", sLote)
            Select Case sTipoImp
                Case "PDF"
#Region "Exportar a PDF"
                    'Preparamos para la exportación
                    sReport = sFileName & "Etiqueta_" & sDocNum & ".pdf"
                    'Compruebo si existe y lo borro
                    If IO.File.Exists(sReport) Then
                        IO.File.Delete(sReport)
                    End If
                    oObjGlobal.SBOApp.StatusBar.SetText("Generando pdf para envio impresión...Espere por favor", BoMessageTime.bmt_Short, BoStatusBarMessageType.smt_Warning)
...
#Region "Imprimir a impresora"
                    ...
                    If EXO_GLOBALES.IsPrinterOnline(sImpresora) = True Then
                        oObjGlobal.SBOApp.StatusBar.SetText("Imprimiendo en " & sImpresora & "...Espere por favor", BoMessageTime.bmt_Short, BoStatusBarMessageType.smt_Warning)
...
#End Region
        ...
        Catch ex As Exception
            Throw ex
        Finally
            oObjGlobal.SBOApp.StatusBar.SetText("Fin del proceso de impresión.", BoMessageTime.bmt_Short, BoStatusBarMessageType.smt_Success)
            oCRReport = Nothing
            oFileDestino = Nothing
        End Try
    End Sub
    Public Shared Sub GenerarImpCrystal4(ByRef oObjGlobal As EXO_UIAPI.EXO_UIAPI, ByVal rutaCrystal As String, ByVal sCrystal As String,
                                        ByVal sDocNum As String, ByVal sDocType As String, ByVal sFileName As String, ByRef sReport As String,
                                         ByVal sTipoImp As String, ByVal sUsuario As String)
        ...
        Try
            ...
            'Establecemos los parámetros para el report.
            oCRReport.SetParameterValue("Schema@", sBBDD)
            oCRReport.SetParameterValue("DocEntry_Entrada", sDocNum)
            oCRReport.SetParameterValue("Objeto", sDocType)
            Select Case sTipoImp
                Case "PDF"
#Region "Exportar a PDF"
                    'Preparamos para la exportación
...
#End Region
        ...
        End Try
    End Sub
    Public Shared Sub GenerarImpCrystal3(ByRef oObjGlobal As EXO_UIAPI.EXO_UIAPI, ByVal rutaCrystal As String, ByVal sCrystal As String,
                                        ByVal sDocNum As String, ByVal sFileName As String, ByRef sReport As String, ByVal sTipoImp As String, ByVal sUsuario As String)
        ...
        Try
            ...
            'Establecemos los parámetros para el report.
            oCRReport.SetParameterValue("Schema@", sBBDD)
            oCRReport.SetParameterValue("Ubicación", sDocNum)
            Select Case sTipoImp
                Case "PDF"
#Region "Exportar a PDF"
                    'Preparamos para la exportación
...
#End Region
    ...
    Public Shared Sub GenerarImpCrystal2(ByRef oObjGlobal As EXO_UIAPI.EXO_UIAPI, ByVal rutaCrystal As String, ByVal sCrystal As String,
                                        ByVal sDocNum As String, ByVal sFileName As String, ByRef sReport As String, ByVal sTipoImp As String, ByVal sUsuario As String)
...
#End Region
    ...
    Public Shared Sub GenerarImpCrystal(ByRef oObjGlobal As EXO_UIAPI.EXO_UIAPI, ByVal rutaCrystal As String, ByVal sCrystal As String,
        ...
        Try
            ...
            Next
            'Establecemos los parámetros para el report.
            oCRReport.SetParameterValue("Usuario", sUsuario)
            Select Case sTipoImp
                Case "PDF"
#Region "Exportar a PDF"
                    'Preparamos para la exportación
