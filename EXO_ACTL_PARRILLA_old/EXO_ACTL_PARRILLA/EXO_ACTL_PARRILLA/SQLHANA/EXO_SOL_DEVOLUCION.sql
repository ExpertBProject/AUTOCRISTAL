 CREATE VIEW "EXO_SOL_DEVOLUCION"  AS

SELECT DISTINCT CAST('SDPROV' as nVARCHAR(50)) "T. SALIDA", CAST(IFNULL(T2."Name",' ') as nVARCHAR(50)) "DELEGACIÓN", CAST(T0."DocEntry" as nVARCHAR(50)) "Nº INTERNO", CAST(T0."DocNum" as nVARCHAR(50)) "Nº DOCUMENTO", 
