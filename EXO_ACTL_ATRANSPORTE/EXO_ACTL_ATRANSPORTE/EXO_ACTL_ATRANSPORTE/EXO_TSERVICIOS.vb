...
#End Region
    ...
    Private Sub cargaCampos()
        If objGlobal.refDi.comunes.esAdministrador Then
            ...
            oXML = objGlobal.funciones.leerEmbebido(Me.GetType(), "UDO_EXO_SERVICIOS.xml")
            objGlobal.refDi.comunes.LoadBDFromXML(oXML)
            objGlobal.SBOApp.StatusBar.SetText("Validado: UDO_EXO_SERVICIOS", SAPbouiCOM.BoMessageTime.bmt_Medium, SAPbouiCOM.BoStatusBarMessageType.smt_Success)
        End If
    End Sub
        ...
        Try
            ...
            If oForm.Visible = True Then
                ...
                If _sIC <> "" Then
                    ...
                    oForm.DataSources.DBDataSources.Item("@EXO_SERVICIOS").SetValue("Code", 0, _sIC)
                    oForm.DataSources.DBDataSources.Item("@EXO_SERVICIOS").SetValue("Name", 0, _sDes)
                End If
    ...
    Private Sub CargarCombos(ByRef objGlobal As EXO_UIAPI.EXO_UIAPI, ByRef oForm As SAPbouiCOM.Form)
        ...
        Try
            ...
            sSQL = "SELECT ""TrnspCode"" ""Código"", ""TrnspName"" ""Servicio"" FROM OSHP  ORDER BY ""TrnspName"" "
                ...
                Select Case oForm.ChooseFromLists.Item(oCFLEvento.ChooseFromListUID).ObjectType
                    Case "EXO_SERVICIOS"
                        Try
                            ...
                            CType(CType(oForm.Items.Item("0_U_G").Specific, SAPbouiCOM.Matrix).Columns.Item("C_0_4").Cells.Item(pVal.Row).Specific, SAPbouiCOM.EditText).Value = sDes
                        Catch ex As Exception
                            oForm.DataSources.DBDataSources.Item("@EXO_SERVICIOSL").SetValue("U_EXO_TARDES", pVal.Row - 1, oDataTable.GetValue("Name", 0).ToString)
                        End Try
