...
Public Class EXO_CONDUCTORES
    ...
    Private Sub cargaCampos()
        If objGlobal.refDi.comunes.esAdministrador Then
            ...
            oXML = objGlobal.funciones.leerEmbebido(Me.GetType(), "UDO_EXO_CONDUCTORES.xml")
            objGlobal.refDi.comunes.LoadBDFromXML(oXML)
            objGlobal.SBOApp.StatusBar.SetText("Validado: UDO_EXO_CONDUCTORES", SAPbouiCOM.BoMessageTime.bmt_Medium, SAPbouiCOM.BoStatusBarMessageType.smt_Success)
        End If
    End Sub
    ...
    Private Function BucarCodeSiguiente() As String
        Dim sSQL As String = ""
        Try
            sSQL = "SELECT ifnull(MAX(Cast(""Code"" as integer)),0)+1 ""Codigo"" FROM ""@EXO_CONDUCTORES"" "
