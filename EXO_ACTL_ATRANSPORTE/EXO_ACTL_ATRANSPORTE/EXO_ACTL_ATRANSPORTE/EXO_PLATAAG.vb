...
#End Region
    ...
    Private Sub cargaCampos()
        If objGlobal.refDi.comunes.esAdministrador Then
            ...
            oXML = objGlobal.funciones.leerEmbebido(Me.GetType(), "UDO_EXO_PLATAAG.xml")
            objGlobal.refDi.comunes.LoadBDFromXML(oXML)
            objGlobal.SBOApp.StatusBar.SetText("Validado: UDO_EXO_PLATAAG", SAPbouiCOM.BoMessageTime.bmt_Medium, SAPbouiCOM.BoStatusBarMessageType.smt_Success)
        End If
    End Sub
        ...
        Try
            ...
            If oForm.Visible = True Then
                ...
                If _sIC <> "" Then
                    ...
                    oForm.DataSources.DBDataSources.Item("@EXO_PLATAAG").SetValue("Code", 0, _sIC)
                    oForm.DataSources.DBDataSources.Item("@EXO_PLATAAG").SetValue("Name", 0, _sDes)
                End If
