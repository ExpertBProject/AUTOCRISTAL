...
Public Class EXO_PNEC
    ...
    Private Shared qtyWhs2 As Integer
    Private Shared qtyOrder2 As Double
    ...
    Private Function EventHandler_FORM_RESIZE_After(ByVal pVal As ItemEvent) As Boolean
        ...
        Try
            ...
            If pVal.ActionSuccess = True Then
                ...
                oForm.Items.Item("grdART").Width = INICIO._WidthART
                oForm.Items.Item("grdART").Height = INICIO._HeightART
                CType(oForm.Items.Item("grdART").Specific, SAPbouiCOM.Grid).AutoResizeColumns()
                ...
                oForm.Items.Item("grdALM2").Width = INICIO._WidthALM
                oForm.Items.Item("grdALM2").Height = INICIO._HeightALM
                CType(oForm.Items.Item("grdALM2").Specific, SAPbouiCOM.Grid).AutoResizeColumns()
        ...
        Try
            ...
            If pVal.ItemUID = "grd_DOC" Then
                If pVal.ColUID.ToUpper = "ORDER" Or pVal.ColUID.ToUpper = "AL0" Or pVal.ColUID.ToUpper = "AL7" Or pVal.ColUID.ToUpper = "AL8" Or pVal.ColUID.ToUpper = "AL14" Or pVal.ColUID.ToUpper = "AL16" Then
                    ...
                    End If
                End If
            ElseIf pVal.ItemUID = "txtALM" Or pVal.ItemUID = "txtALM2" Then
                If oForm.DataSources.UserDataSources.Item("UDALM").Value <> "" And oForm.DataSources.UserDataSources.Item("UDALM2").Value <> "" Then
                    If oForm.DataSources.UserDataSources.Item("UDALM").Value = oForm.DataSources.UserDataSources.Item("UDALM2").Value Then
                        objGlobal.SBOApp.SetStatusBarMessage("El almacen por defecto no puede ser igual al almacen por defecto siguiente grupo de almacenes.")
                        Return False
                    End If
                End If
            ElseIf pVal.ItemUID = "grdALM2" Then
                Dim sAlmacenes As List(Of String) = New List(Of String)()
                For j As Integer = 0 To oForm.DataSources.DataTables.Item("DTALM").Rows.Count - 1
                    If oForm.DataSources.DataTables.Item("DTALM").GetValue("Cod.", j).ToString <> "" And oForm.DataSources.DataTables.Item("DTALM").GetValue("Sel", j).ToString = "Y" Then
                        sAlmacenes.Add(oForm.DataSources.DataTables.Item("DTALM").GetValue("Cod.", j).ToString)
                    End If
                Next
                For i As Integer = 0 To oForm.DataSources.DataTables.Item("DTALM2").Rows.Count - 1
                    If oForm.DataSources.DataTables.Item("DTALM2").GetValue("Cod.", i).ToString <> "" And oForm.DataSources.DataTables.Item("DTALM2").GetValue("Sel", i).ToString = "Y" Then
                        If sAlmacenes.Contains(oForm.DataSources.DataTables.Item("DTALM2").GetValue("Cod.", i).ToString) Then
                            objGlobal.SBOApp.SetStatusBarMessage("El almacen " & oForm.DataSources.DataTables.Item("DTALM2").GetValue("Cod.", i).ToString & " ya existe en el otro grupo de almacenes. Debe quitarlo.")
                            Return False
                        End If
                    End If
                Next
...
#End Region
                ...
                ElseIf pVal.ColUID = "AL0" Or pVal.ColUID = "AL7" Or pVal.ColUID = "AL8" Or pVal.ColUID = "AL14" Or pVal.ColUID = "AL16" Then
                    ...
                    If qtyWhs2 = 0 Then
                        ...
                        End If
                    Else
                        Dim sAlmacenes2 As String = ""
                        Dim iOrder As Integer = 0 : Dim iOrder2 As Integer = 0
                        For i As Integer = 0 To oForm.DataSources.DataTables.Item("DTALM2").Rows.Count - 1
                            If oForm.DataSources.DataTables.Item("DTALM2").GetValue("Sel", i).ToString = "Y" Then
                                If sAlmacenes2 = "" Then
                                    sAlmacenes2 = "'" & oForm.DataSources.DataTables.Item("DTALM2").GetValue("Cod.", i).ToString & "' "
                                Else
                                    sAlmacenes2 &= ", '" & oForm.DataSources.DataTables.Item("DTALM2").GetValue("Cod.", i).ToString & "' "
                                End If
                            End If
                        ...
                        End If
                        oForm.DataSources.DataTables.Item("DT_DOC").Columns.Item("OrigOrder").Cells.Item(gridOrder.GetDataTableRowIndex(pVal.Row)).Value = al0 + al7 + al8 + al14 + al16
                        oForm.DataSources.DataTables.Item("DT_DOC").Columns.Item("Order").Cells.Item(gridOrder.GetDataTableRowIndex(pVal.Row)).Value = iOrder
                        Try
                            oForm.DataSources.DataTables.Item("DT_DOC").Columns.Item("Order2").Cells.Item(gridOrder.GetDataTableRowIndex(pVal.Row)).Value = iOrder2
                        Catch ex As Exception
...
#End Region
    ...
    Private Function EventHandler_Choose_FromList_Before(ByRef pVal As ItemEvent) As Boolean
        ...
        Dim sAlmacenes As String = "" : Dim sAlmacenes2 As String = ""
...
#Region "Comprobar si ha elegido un almacen"
                ...
                End If
#End Region
            ElseIf pVal.ItemUID = "txtALM2" Then
                'comprobamos que tenga almacenes seleccionados
#Region "Comprobar si ha elegido un almacen"
                sAlmacenes2 = ""
                For i As Integer = 0 To oForm.DataSources.DataTables.Item("DTALM2").Rows.Count - 1
                ...
                If sAlmacenes2 = "" Then
                    sMensaje = "No ha indicado un almacén en el grupo 2. Es obligatorio indicar uno."
                    objGlobal.SBOApp.StatusBar.SetText("(EXO) - " & sMensaje, SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Warning)
                    objGlobal.SBOApp.MessageBox(sMensaje)
                    Return False
                Else
                    Dim sAAlmacenes2() As String = sAlmacenes2.Split(CType(",", Char))
                    Dim iAlmacenes2 As Integer = 0
                    oCFLEvento = CType(pVal, IChooseFromListEvent)

                    oConds = New SAPbouiCOM.Conditions
                    For Each Almacen2 In sAAlmacenes2
                        iAlmacenes2 += 1
                        If iAlmacenes2 > 1 Then
                            oCond.Relationship = SAPbouiCOM.BoConditionRelationship.cr_OR
                        End If
                        oCond = oConds.Add
                        oCond.Alias = "WhsCode"
                        oCond.Operation = SAPbouiCOM.BoConditionOperation.co_EQUAL
                        oCond.CondVal = Almacen2
                    Next
                    oForm.ChooseFromLists.Item(oCFLEvento.ChooseFromListUID).SetConditions(oConds)
                End If
#End Region
                ...
                Select Case oForm.ChooseFromLists.Item(oCFLEvento.ChooseFromListUID).ObjectType
                    Case "64" 'Almacenes
                        Try
                            ...
                            ElseIf pVal.ItemUID = "txtALM2" Then
                                oForm.DataSources.UserDataSources.Item("UDALM2").ValueEx = oDataTable.GetValue("WhsCode", 0).ToString
                            End If
        ...
        Try
            ...
            Select Case pVal.ItemUID
                ...
                Case "btnGen"
                    ...
                    End If
                Case "btnImp"
#Region "Importar Lista artículos"
                    If CargarFormImp(oForm) = False Then
                        Exit Function
                    End If
#End Region
                Case "btnVAC"
#Region "Vaciar Lista Artículos"
                    oForm.Freeze(True)
                    sSQL = "SELECT '' ""Código"", ' ' ""Descripción"" FROM DUMMY"
                    oForm.DataSources.DataTables.Item("DTART").ExecuteQuery(sSQL)
                    FormateaGridART(oForm)
                    oForm.Freeze(False)
#End Region
                Case "btnSAVE"
#Region "Guardar Filtro"
                    If GuardarFiltro(oForm) = False Then
                        Return False
                    End If
#End Region
                Case "btnREC"
#Region "Recuperar Filtro"
                    If RecuperarFiltro(oForm) = False Then
                        Return False
                    End If
#End Region
            End Select
...
#End Region
        Try
            ...
            If ComprobarALM(objGlobal, oForm, "DTALM") = True Then
#Region "Comprobar si ha elegido un almacen"
                qtyWhs = 0 : qtyWhs2 = 0
                sAlmacenes = "" : sAlmacenes2 = ""
                For i As Integer = 0 To oForm.DataSources.DataTables.Item("DTALM").Rows.Count - 1
                    If oForm.DataSources.DataTables.Item("DTALM").GetValue("Sel", i).ToString = "Y" Then
                        If sAlmacenes = "" Then
                            sAlmacenes = "'" & oForm.DataSources.DataTables.Item("DTALM").GetValue("Cod.", i).ToString & "' "
...
#End Region
                ...
                If (sAlmacenes.Contains("AL0")) Or (sAlmacenes2.Contains("AL0")) Then
                    stockTT &= "+0+CAST(IFNULL(T5.""Stock_AL0"",0) AS INTEGER)"
                End If
                If (sAlmacenes.Contains("AL14")) Or (sAlmacenes2.Contains("AL14")) Then
                    stockTT &= "+0+CAST(IFNULL(T5.""Stock_AL14"",0) AS INTEGER)"
                End If
                If (sAlmacenes.Contains("AL16")) Or (sAlmacenes2.Contains("AL16")) Then
                    stockTT &= "+0+CAST(IFNULL(T5.""Stock_AL16"",0) AS INTEGER)"
                End If
                If (sAlmacenes.Contains("AL7")) Or (sAlmacenes2.Contains("AL7")) Then
                    stockTT &= "+0+CAST(IFNULL(T5.""Stock_AL7"",0) AS INTEGER)"
                End If
                If (sAlmacenes.Contains("AL8")) Or (sAlmacenes2.Contains("AL8")) Then
                ...
                sSQLGrid &= "   CAST(IFNULL(T6.""Pdte_AL0"",0) AS INTEGER) ""P_A0"" , 
                                        ...
                                        T4.""24M_Q_AL7"" ""VM_A7"", 
                                        T4.""24M_Q_AL8"" ""VM_A8"", "
#Region "Ventas perdidas"
                sSQLGrid &= " IFNULL(VP.""CUENTA"",0) ""VP"","
#End Region
                sSQLGrid &= " ( (CASE WHEN "
...
#End Region
                ...
                If (sAlmacenes.Contains("AL0") And qtyWhs > 1) Or (sAlmacenes2.Contains("AL0") And qtyWhs2 > 1) Then
                ...
                If (sAlmacenes.Contains("AL7") And qtyWhs > 1) Or (sAlmacenes2.Contains("AL7") And qtyWhs2 > 1) Then
                ...
                If (sAlmacenes.Contains("AL8") And qtyWhs > 1) Or (sAlmacenes2.Contains("AL8") And qtyWhs2 > 1) Then
                ...
                If (sAlmacenes.Contains("AL14") And qtyWhs > 1) Or (sAlmacenes2.Contains("AL14") And qtyWhs2 > 1) Then
                ...
                If (sAlmacenes.Contains("AL16") And qtyWhs > 1) Or (sAlmacenes2.Contains("AL16") And qtyWhs2 > 1) Then
...
LEFT JOIN (SELECT COUNT(""ID"") ""CUENTA"",""REFERENCIA"" 
            ...
            WHERE ""FECHA"">= ADD_MONTHS(ADD_DAYS(CURRENT_DATE,-EXTRACT(DAY FROM CURRENT_DATE) + 1),	 -12) 
            GROUP BY ""REFERENCIA"") VP ON VP.""REFERENCIA""=T0.""ItemCode""
...
WHERE  1=1 and T0.""QryGroup2""='N' and T0.""validFor""='Y'"
                ...
                End If
#Region "Filtro Artículos"
                If oForm.DataSources.DataTables.Item("DTART").Rows.Count > 0 And oForm.DataSources.DataTables.Item("DTART").GetValue("Código", 0).ToString <> "" Then
                    Dim sArticulos As String = ""
                    For j As Integer = 0 To oForm.DataSources.DataTables.Item("DTART").Rows.Count - 1
                        If sArticulos = "" Then
                            If oForm.DataSources.DataTables.Item("DTART").GetValue("Código", j).ToString <> "" Then
                                sArticulos = "'" & oForm.DataSources.DataTables.Item("DTART").GetValue("Código", j).ToString & "'"
                            End If
                        Else
                            If oForm.DataSources.DataTables.Item("DTART").GetValue("Código", j).ToString <> "" Then
                                sArticulos &= ",'" & oForm.DataSources.DataTables.Item("DTART").GetValue("Código", j).ToString & "'"
                        ...
                        End If
                    Next
                    If sArticulos.Trim <> "" Then
                        sSQLGrid &= " and T0.""ItemCode"" in (" & sArticulos & ") "
                    Else
                        If sArtD <> "" Then
...
#End Region
                ...
                FormateaGridDOC(oForm, sAlmacenes, If(qtyWhs = 1, False, True), sAlmacenes2, If(qtyWhs2 = 1, False, True))
...
#End Region
        ...
        End Try
    End Function
    Public Function RecuperarFiltro(ByRef oformOrigen As SAPbouiCOM.Form) As Boolean
        Dim oForm As SAPbouiCOM.Form = Nothing
        Dim sSQL As String = ""
        Dim oFP As SAPbouiCOM.FormCreationParams = Nothing

        RecuperarFiltro = False
        ...
        Try
            ...
            oFP.XmlData = objGlobal.leerEmbebido(Me.GetType(), "EXO_PLNREC.srf")

            Try
                oForm = objGlobal.SBOApp.Forms.AddEx(oFP)
                oForm.DataSources.UserDataSources.Item("UDFRM").Value = oformOrigen.UniqueID
            Catch ex As Exception
        ...
        End Try
    End Function
    Public Function GuardarFiltro(ByRef oformOrigen As SAPbouiCOM.Form) As Boolean
        Dim oForm As SAPbouiCOM.Form = Nothing
        Dim sSQL As String = ""
        Dim oFP As SAPbouiCOM.FormCreationParams = Nothing
        ...
        Try
            oFP = CType(objGlobal.SBOApp.CreateObject(SAPbouiCOM.BoCreatableObjectType.cot_FormCreationParams), SAPbouiCOM.FormCreationParams)
            oFP.XmlData = objGlobal.leerEmbebido(Me.GetType(), "EXO_PLNSAVE.srf")
        ...
        End Try
    End Function
    Public Function CargarFormImp(ByRef oformOrigen As SAPbouiCOM.Form) As Boolean
        Dim oForm As SAPbouiCOM.Form = Nothing
        Dim sSQL As String = ""
        Dim oFP As SAPbouiCOM.FormCreationParams = Nothing
        ...
        Try
            oFP = CType(objGlobal.SBOApp.CreateObject(SAPbouiCOM.BoCreatableObjectType.cot_FormCreationParams), SAPbouiCOM.FormCreationParams)
            oFP.XmlData = objGlobal.leerEmbebido(Me.GetType(), "EXO_IMPART.srf")
    ...
    Private Sub CalculateGridCheckValues(ByRef oForm As Form, ByVal row As Integer)
        ...
        If (valueSel.Equals("Y")) Then
            ...
            Try
                qtyOrder2 += dt.Columns.Item("Order2").Cells.Item(gridOrder.GetDataTableRowIndex(row)).Value.ToString().DoubleParseAdvanced
            Catch ex As Exception
                qtyOrder2 = 0
            End Try
        Else
        ...
        Try
            CType(CType(oForm.Items.Item("grd_DOC").Specific, Grid).Columns.Item("Order2"), EditTextColumn).ColumnSetting.SumValue = qtyOrder2.ToString
        Catch ex As Exception
...
#End Region
            ...
            ElseIf (whsSelected.Count > 1) Then
                ...
                Dim whsDef2 = oForm.DataSources.UserDataSources.Item("UDALM2").Value.Trim
...
#End Region
                Else
                    ...
                    Dim shouldCreateTransfer As Integer = 2
                    If whsDef2 = "" Then
                        shouldCreateTransfer = objGlobal.SBOApp.MessageBox("Desea crear los traslados para los pedidos seleccionados?", 1, "Si", "No")
                    End If
...
#End Region
                    If whsDef2 <> "" Then
#Region "Creacion de solicitud de Compra2"
                        dSumaCantidad = 0
                        For i As Integer = 0 To rowsGrouped.Count - 1
                            Dim prov = rowsGrouped(i).Key.Value
                            Dim solPedComp = CType(objGlobal.compañia.GetBusinessObject(SAPbobsCOM.BoObjectTypes.oPurchaseQuotations), SAPbobsCOM.Documents)
                            ...
                            For x As Integer = 0 To rowsGrouped(i).Count - 1
                                Dim fechaPrev = CType(rowsGrouped(i).Descendants("Cell").Where(Function(attr) CType(attr.FirstNode, XElement).Name.ToString().Equals("ColumnUid") And CType(attr.FirstNode, XElement).Value.ToString.Equals("Fecha Prev.")).First().LastNode, XElement).Value
                                Dim itemCode = CType(CType(rowsGrouped(i).ToList()(x), XElement).Descendants("Cell").Where(Function(attr) CType(attr.FirstNode, XElement).Name.ToString().Equals("ColumnUid") And CType(attr.FirstNode, XElement).Value.ToString.Equals("EUROCODE")).First().LastNode, XElement).Value
                                Dim order = CType(CType(rowsGrouped(i).ToList()(x), XElement).Descendants("Cell").Where(Function(attr) CType(attr.FirstNode, XElement).Name.ToString().Equals("ColumnUid") And CType(attr.FirstNode, XElement).Value.ToString.Equals("Order2")).First().LastNode, XElement).Value
                                'Dim al0 = CType(CType(rowsGrouped(i).ToList()(x), XElement).Descendants("Cell").Where(Function(attr) CType(attr.FirstNode, XElement).Name.ToString().Equals("ColumnUid") And CType(attr.FirstNode, XElement).Value.ToString.Equals("AL0")).First().LastNode, XElement).Value
                                'Dim al7 = CType(CType(rowsGrouped(i).ToList()(x), XElement).Descendants("Cell").Where(Function(attr) CType(attr.FirstNode, XElement).Name.ToString().Equals("ColumnUid") And CType(attr.FirstNode, XElement).Value.ToString.Equals("AL7")).First().LastNode, XElement).Value
                                'Dim al8 = CType(CType(rowsGrouped(i).ToList()(x), XElement).Descendants("Cell").Where(Function(attr) CType(attr.FirstNode, XElement).Name.ToString().Equals("ColumnUid") And CType(attr.FirstNode, XElement).Value.ToString.Equals("AL8")).First().LastNode, XElement).Value
                                'Dim al14 = CType(CType(rowsGrouped(i).ToList()(x), XElement).Descendants("Cell").Where(Function(attr) CType(attr.FirstNode, XElement).Name.ToString().Equals("ColumnUid") And CType(attr.FirstNode, XElement).Value.ToString.Equals("AL14")).First().LastNode, XElement).Value
...
#End Region
    ...
    Private Function Calculo_Pedir_Agrupado(ByRef oObjglobal As EXO_UIAPI.EXO_UIAPI, ByRef oForm As SAPbouiCOM.Form, ByVal dFecha As Date, ByVal dFechaAnt As Date,
        ...
        End Try
    End Function
    Public Shared Function ComprobarALM(ByRef oObjglobal As EXO_UIAPI.EXO_UIAPI, ByRef oForm As SAPbouiCOM.Form, ByVal sFra As String) As Boolean
        ...
        End Try
    End Function
    Public Shared Sub FormateaGridDOC(ByRef oform As SAPbouiCOM.Form, ByVal sAlmacenes As String, ByVal isMultiple As Boolean, ByVal sAlmacenes2 As String, ByVal isMultiple2 As Boolean)
        Dim oColumnTxt As SAPbouiCOM.EditTextColumn = Nothing
        ...
        Try
            ...
            For i = 1 To iColumnas - 1
                ...
                ElseIf sTitulo.Contains("PRECIO") Then
                    oColumnTxt.Editable = True
                    oColumnTxt.RightJustified = True
                ElseIf sTitulo.Contains("VP") Or sTitulo.Contains("VA") Or sTitulo.Contains("VM_") Or sTitulo.Contains("ST") Or sTitulo.Contains("PDTE") Or sTitulo.Contains("T-") Or sTitulo.Contains("PEDIR") Or sTitulo.Contains("UC") Then
                    oColumnTxt.RightJustified = True
                ...
                ElseIf sTitulo.Contains("AL0") Or sTitulo.Contains("AL7") Or sTitulo.Contains("AL8") Or sTitulo.Contains("AL14") Or sTitulo.Contains("AL16") Then
                    ...
                    If (isMultiple2) Then
                        If sAlmacenes2.Contains(sTitulo) Then
                            oColumnTxt.Editable = True
                        End If
                    Else
                        If sAlmacenes2.Contains(sTitulo) Then
            ...
            CType(CType(oform.Items.Item("grd_DOC").Specific, Grid).Columns.Item("Order"), EditTextColumn).ColumnSetting.SumType = BoColumnSumType.bst_Auto
            CType(CType(oform.Items.Item("grd_DOC").Specific, Grid).Columns.Item("Order"), EditTextColumn).ColumnSetting.SumValue = "0"
            Try
                CType(CType(oform.Items.Item("grd_DOC").Specific, Grid).Columns.Item("Order2"), EditTextColumn).ColumnSetting.SumType = BoColumnSumType.bst_Auto
                CType(CType(oform.Items.Item("grd_DOC").Specific, Grid).Columns.Item("Order2"), EditTextColumn).ColumnSetting.SumValue = "0"
            Catch ex As Exception
    ...
    Public Function CargarForm() As Boolean
        ...
        Try
            ...
            oForm.DataSources.DataTables.Item("DTALM2").ExecuteQuery(sSQL)
            FormateaGridALM2(oForm)
...
#End Region
        ...
        End Try
    End Function
    Public Shared Sub FormateaGridVENT(ByRef oform As SAPbouiCOM.Form)
        Dim oColumnTxt As SAPbouiCOM.EditTextColumn = Nothing
        Dim oColumnChk As SAPbouiCOM.CheckBoxColumn = Nothing
        Dim oColumnCb As SAPbouiCOM.ComboBoxColumn = Nothing
        Dim sSQL As String = ""
        ...
        End Try
    End Sub
    Public Shared Sub FormateaGridCOMP(ByRef oform As SAPbouiCOM.Form)
        Dim oColumnTxt As SAPbouiCOM.EditTextColumn = Nothing
        Dim oColumnChk As SAPbouiCOM.CheckBoxColumn = Nothing
        Dim oColumnCb As SAPbouiCOM.ComboBoxColumn = Nothing
        Dim sSQL As String = ""
    ...
    Public Shared Sub FormateaGridART(ByRef oform As SAPbouiCOM.Form)
        Dim oColumnTxt As SAPbouiCOM.EditTextColumn = Nothing
        Dim oColumnChk As SAPbouiCOM.CheckBoxColumn = Nothing
        Dim oColumnCb As SAPbouiCOM.ComboBoxColumn = Nothing
        Dim sSQL As String = ""
        Try
            ...
            For i = 0 To 1
                CType(oform.Items.Item("grdART").Specific, SAPbouiCOM.Grid).Columns.Item(i).Type = SAPbouiCOM.BoGridColumnType.gct_EditText
                oColumnTxt = CType(CType(oform.Items.Item("grdART").Specific, SAPbouiCOM.Grid).Columns.Item(i), SAPbouiCOM.EditTextColumn)
                oColumnTxt.Editable = False
                If i = 0 Then
                    oColumnTxt.LinkedObjectType = "4"
                End If
        ...
        End Try
    End Sub
    Public Shared Sub FormateaGridALM(ByRef oform As SAPbouiCOM.Form)
        Dim oColumnTxt As SAPbouiCOM.EditTextColumn = Nothing
        Dim oColumnChk As SAPbouiCOM.CheckBoxColumn = Nothing
        Dim oColumnCb As SAPbouiCOM.ComboBoxColumn = Nothing
        Dim sSQL As String = ""
        ...
        End Try
    End Sub
    Public Shared Sub FormateaGridALM2(ByRef oform As SAPbouiCOM.Form)
        Dim oColumnTxt As SAPbouiCOM.EditTextColumn = Nothing
        Dim oColumnChk As SAPbouiCOM.CheckBoxColumn = Nothing
        Dim oColumnCb As SAPbouiCOM.ComboBoxColumn = Nothing
        Dim sSQL As String = ""
        Try
            oform.Freeze(True)
            CType(oform.Items.Item("grdALM2").Specific, SAPbouiCOM.Grid).Columns.Item(0).Type = SAPbouiCOM.BoGridColumnType.gct_CheckBox
            oColumnChk = CType(CType(oform.Items.Item("grdALM2").Specific, SAPbouiCOM.Grid).Columns.Item(0), SAPbouiCOM.CheckBoxColumn)
            oColumnChk.Editable = True
            oColumnChk.Width = 30

            For i = 1 To 2
                CType(oform.Items.Item("grdALM2").Specific, SAPbouiCOM.Grid).Columns.Item(i).Type = SAPbouiCOM.BoGridColumnType.gct_EditText
                oColumnTxt = CType(CType(oform.Items.Item("grdALM2").Specific, SAPbouiCOM.Grid).Columns.Item(i), SAPbouiCOM.EditTextColumn)
                oColumnTxt.Editable = False
            Next
        ...
        End Try
    End Sub
    Public Shared Sub FormateaGridGRU(ByRef oform As SAPbouiCOM.Form)
        Dim oColumnTxt As SAPbouiCOM.EditTextColumn = Nothing
        Dim oColumnChk As SAPbouiCOM.CheckBoxColumn = Nothing
        Dim oColumnCb As SAPbouiCOM.ComboBoxColumn = Nothing
        Dim sSQL As String = ""
        ...
        End Try
    End Sub
    Public Shared Sub FormateaGridCLAS(ByRef oform As SAPbouiCOM.Form)
        Dim oColumnTxt As SAPbouiCOM.EditTextColumn = Nothing
        Dim oColumnChk As SAPbouiCOM.CheckBoxColumn = Nothing
        Dim oColumnCb As SAPbouiCOM.ComboBoxColumn = Nothing
        Dim sSQL As String = ""
