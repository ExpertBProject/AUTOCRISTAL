...
#Region "Connect to Company"
    Public Shared Sub Connect_Company(ByRef oCompany As SAPbobsCOM.Company, ByVal sClave As String, ByVal sBBDD As String, ByVal sUsuario As String, ByVal sPassword As String, ByRef oLog As EXO_Log.EXO_Log)
        Dim myStream As Stream = Nothing
        Dim Reader As XmlTextReader = Nothing
        ...
        End Try
    End Sub
    Public Shared Sub Connect_CompanySQL(ByRef oCompany As SAPbobsCOM.Company, ByVal sClave As String, ByVal sBBDD As String, ByVal sUsuario As String, ByVal sPassword As String, ByRef oLog As EXO_Log.EXO_Log)
        Dim myStream As Stream = Nothing
        Dim Reader As XmlTextReader = Nothing
