...
Public Class INICIO
    ...
    Private Sub ParametrizacionGeneral()
        ...
        If Not objGlobal.funcionesUI.refDi.OGEN.existeVariable("ENV_Mail") Then
            objGlobal.funcionesUI.refDi.OGEN.fijarValorVariable("ENV_Mail", "consultas@autocristalsevilla.com")
        End If
        If Not objGlobal.funcionesUI.refDi.OGEN.existeVariable("ENV_US") Then
            objGlobal.funcionesUI.refDi.OGEN.fijarValorVariable("ENV_US", "consultas@autocristalsevilla.com")
        End If
        If Not objGlobal.funcionesUI.refDi.OGEN.existeVariable("ENV_PS") Then
            objGlobal.funcionesUI.refDi.OGEN.fijarValorVariable("ENV_PS", "Cons202006")
        End If
        If Not objGlobal.funcionesUI.refDi.OGEN.existeVariable("ENV_SMTP") Then
            objGlobal.funcionesUI.refDi.OGEN.fijarValorVariable("ENV_SMTP", "smtp.serviciodecorreo.es")
        End If
        If Not objGlobal.funcionesUI.refDi.OGEN.existeVariable("ENV_PORT") Then
            objGlobal.funcionesUI.refDi.OGEN.fijarValorVariable("ENV_PORT", "465")
        End If
        If Not objGlobal.funcionesUI.refDi.OGEN.existeVariable("ENV_CMail") Then
            objGlobal.funcionesUI.refDi.OGEN.fijarValorVariable("ENV_CMail", "consultas@autocristalsevilla.com")
        End If
    ...
    Private Sub cargaDatos()
        ...
        If objGlobal.refDi.comunes.esAdministrador Then
            ...
            sSQL = objGlobal.funciones.leerEmbebido(Me.GetType(), "EXO_RECAL_CONTROL_STOCK.sql")
            ...
            Else
                objGlobal.SBOApp.StatusBar.SetText("No se ha podido crear el procedure...", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error)
            End If
        End If
    End Sub
