CREATE PROCEDURE _98_EXO_CHK_OITG
(
    		...
    		DECLARE EXIT HANDLER FOR SQLEXCEPTION
           	...
           	FOR c_row_EMP AS c_EMP DO
                ...
                vU_EXO_BBDD := c_row_EMP.BBDD;   
              	SELECT T0."ItmsGrpNam" INTO  vDes FROM OITG T0 WHERE T0."ItmsTypCod" = :pList_of_cols_val_tab_del;
                ...
                IF (:vHAYDATO) = '0' THEN
					...
					VALUES (vCode,vU_EXO_BBDD,:pObject_type,'OITG',:pList_of_cols_val_tab_del,vDes,'','',TO_NVARCHAR(CURRENT_DATE, 'YYYY/MM/DD'));
				ELSE
				 	--DELETE
					DELETE FROM "REPLICATE" WHERE  "DBNAMEORIG" = vCode AND  "DBNAMEDEST"= vU_EXO_BBDD AND "CODETABLE" =  :pList_of_cols_val_tab_del  AND "TABLENAME"='OITG';
					-- INSERT
					INSERT INTO "REPLICATE" ("DBNAMEORIG","DBNAMEDEST","TABLECATEGORY","TABLENAME","CODETABLE","CODETABLE2","CODETABLE3", "CODETABLE4","DATEADD")
					VALUES (vCode,vU_EXO_BBDD,:pObject_type,'OITG',:pList_of_cols_val_tab_del,vDes,'','',TO_NVARCHAR(CURRENT_DATE, 'YYYY/MM/DD'));
				END IF;
